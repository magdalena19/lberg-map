/*
 CAUTION IN CASE OF UPDATE PURPOSES:
 This version has been modified to prevent adding <br> tags on empty text fields.
*/
...
var nicEditorInstance = bkClass.extend({
	...
	init : function() {
		...
		// We do not want any new lines being inserted...
		// if(this.getContent() == "") {
		// 	this.setContent('<br />');
		// }
