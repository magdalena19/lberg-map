...
describe AnnouncementsController do
  ...
  context 'GET #edit' do
    it 'populates the correct announcement in @announcement' do
      get :edit, id: announcement.id, map_token: @map.public_token
  ...
  context 'GET #new' do
    it 'populates a new announcement in @announcement' do
      get :new, map_token: @map.public_token
  ...
  context 'GET #show' do
    it 'populates the correct announcement in @announcement' do
      get :show, id: announcement.id, map_token: @map.public_token
      expect(assigns(:announcement)).to eq(announcement)
    end
  ...
  context 'DELETE #destroy' do
    ...
    context 'rejects deletion' do
      it 'if not logged in' do
        logout
        delete :destroy, id: announcement.id, map_token: @map.public_token
