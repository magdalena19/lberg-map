...
ActiveRecord::Schema.define(version: 20160427151413) do
  ...
  create_table "places", force: :cascade do |t|
    ...
    t.string   "postal_code",  default: "Default postal code", null: false
    t.string   "street",       default: "Default street",      null: false
    t.string   "house_number"
    t.string   "city",         default: "Default city",        null: false
  end
