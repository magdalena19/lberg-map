...
class Map < ActiveRecord::Base
  ...
  TILE_LAYERS = {
    ...
    'ESRI Topo' => {
      ...
      image_url: "https://server.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/#{TILE_POSITION[:z]}/#{TILE_POSITION[:y]}/#{TILE_POSITION[:x]}"
    },
    'ESRI Grey' => {
      url: 'https://server.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Light_Gray_Base/MapServer/tile/{z}/{y}/{x}',
      attribution: 'Source: Esri, DeLorme, NAVTEQ',
      image_url: "https://server.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Light_Gray_Base/MapServer/tile/#{TILE_POSITION[:z]}/#{TILE_POSITION[:y]}/#{TILE_POSITION[:x]}"
    },
    'Stamen Terrain' => {
      ...
      image_url: "https://stamen-tiles.a.ssl.fastly.net/terrain/#{TILE_POSITION[:z]}/#{TILE_POSITION[:x]}/#{TILE_POSITION[:y]}.jpg"
    }
  }.freeze
end
